...
var viewtype = 3; // the default viewtype (should be 1,2,3,4 or 5)
var colourtype = 2; // the default colour mode - note: if doing further editing of colour palette's below this may become irrelevant
...
var backgroundcolor = 'rgb(250,250,255)' //background color 'null' if no background is wanted
...
var innode_label_help = true; // supresses the cutting out of 'namingtodo' labels in the interior nodes of the tree
...
var mintextsize = 1; // the smallest size text you want to have displayed

var sensitivity = 0.84; // for mouse sensitivity
var sensitivity3 = 0.9;
var sensitivity2 = 0.88; // for mouse sensitivity
var threshold =0; // for the detail threshold
var thresholdtxt =0; // for the detail threshold
